...
constexpr const wchar_t *kSharedMemKeyboard =
    L"\\BaseNamedObjects\\CursorShareKbdShm";
constexpr const wchar_t *kSharedMemMouse =
    L"\\BaseNamedObjects\\CursorShareMouShm";
